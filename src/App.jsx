...
const handleCalculatere =(e)=>{
  // e.defualtPrevent()
  console.log("inside calculater");
  ...
  return (
    ...
    <div style={{width:'100%',minHeight:'100vh'}} className='d-flex justify-content-center align-items-center bg-dark'> 
      <div className='bg-light rounded p-5' style={{width:'600px'}} >
        ...
        <Button disabled={invalid || invalidRate || invalidYear} onClick={handleCalculatere} type='submit' style={{width:'50%',height:'70px'}} className='bg-dark' variant="contained">Calculate</Button>
        <Button onClick={resetCal} style={{width:'50%',height:'70px'}} variant="outlined">Reset</Button>
        </Stack>
      </div>
    </div>
    </>
